            ...
            >
                ...
                >
                  <div className="relative">
                    <motion.div
                      ...
                      className="absolute inset-0 w-24 h-24 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full blur-xl opacity-50"
                    />
                ...
                <div className="glass rounded-2xl p-4 border border-purple-500/30">
                  <AnimatePresence mode="wait">
                    <motion.p
                      ...
                      exit={{ opacity: 0, x: -20 }}
                      className="text-center text-white/70 flex items-center justify-center gap-2"
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {nextSteps.map((step, index) => (
                    <motion.div
                      ...
                      className="glass rounded-xl p-6 border border-white/10 hover:border-purple-500/50 transition-all duration-300"
                    >
                      <motion.div
                        animate={{ 
                          rotate: [0, 10, -10, 0],
              ...
              >
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => navigate('/')}
                  className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl font-semibold hover:shadow-xl hover:shadow-purple-500/25 transition-all duration-300 flex items-center justify-center gap-2"
                >
                  Back to Home
                ...
                <motion.a
                  ...
                  className="px-8 py-4 glass border border-purple-500/30 text-white rounded-xl font-semibold hover:bg-white/10 transition-all duration-300 flex items-center justify-center gap-2"
                >
