      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <button
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-16 bg-white/10 backdrop-blur-sm p-3 rounded-full text-white hover:bg-white/20 transition-colors duration-200"
          >
          ...
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-16 bg-white/10 backdrop-blur-sm p-3 rounded-full text-white hover:bg-white/20 transition-colors duration-200"
          >
